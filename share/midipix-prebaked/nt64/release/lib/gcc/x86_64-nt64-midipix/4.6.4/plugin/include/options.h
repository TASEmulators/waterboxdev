...
#ifndef GENERATOR_FILE
  int x_VAR_mldso;
#define x_VAR_mldso do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mldso_absolute_path;
#define x_VAR_mldso_absolute_path do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mldso_app_dir_only;
#define x_VAR_mldso_app_dir_only do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mldso_default_path;
#define x_VAR_mldso_default_path do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mldso_kernel_driver;
#define x_VAR_mldso_kernel_driver do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mldso_root_relative;
#define x_VAR_mldso_root_relative do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mntapi;
#define x_VAR_mntapi do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mout_implib;
#define x_VAR_mout_implib do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_moutput_def;
#define x_VAR_moutput_def do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mposix;
#define x_VAR_mposix do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mtty_console;
#define x_VAR_mtty_console do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_posix;
#define x_VAR_posix do_not_use
#endif
#ifndef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_march_ = 960,                          /* -march= */
  OPT_masm_ = 961,                           /* -masm= */
  OPT_mavx = 962,                            /* -mavx */
  OPT_mavx256_split_unaligned_load = 963,    /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 964,   /* -mavx256-split-unaligned-store */
  OPT_mbmi = 965,                            /* -mbmi */
  OPT_mbranch_cost_ = 966,                   /* -mbranch-cost= */
  OPT_mcld = 967,                            /* -mcld */
  OPT_mcmodel_ = 968,                        /* -mcmodel= */
  /* OPT_mcpu_ = 969, */                     /* -mcpu= */
  OPT_mcrc32 = 970,                          /* -mcrc32 */
  OPT_mcx16 = 971,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 972,             /* -mdispatch-scheduler */
  OPT_mf16c = 973,                           /* -mf16c */
  OPT_mfancy_math_387 = 974,                 /* -mfancy-math-387 */
  OPT_mfentry = 975,                         /* -mfentry */
  OPT_mfma = 976,                            /* -mfma */
  OPT_mfma4 = 977,                           /* -mfma4 */
  OPT_mforce_drap = 978,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 979,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 980,                        /* -mfpmath= */
  OPT_mfsgsbase = 981,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 982, */               /* -mfused-madd */
  OPT_mhard_float = 983,                     /* -mhard-float */
  OPT_mieee_fp = 984,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 985,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 986,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 987,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 988, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 989,          /* -mlarge-data-threshold= */
  OPT_mldso = 990,                           /* -mldso */
  OPT_mldso_absolute_path = 991,             /* -mldso-absolute-path */
  OPT_mldso_app_dir_only = 992,              /* -mldso-app-dir-only */
  OPT_mldso_default_path = 993,              /* -mldso-default-path */
  OPT_mldso_kernel_driver = 994,             /* -mldso-kernel-driver */
  OPT_mldso_root_relative = 995,             /* -mldso-root-relative */
  OPT_mlwp = 996,                            /* -mlwp */
  OPT_mmmx = 997,                            /* -mmmx */
  OPT_mmovbe = 998,                          /* -mmovbe */
  OPT_mms_bitfields = 999,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 1000,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1001,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1002,                  /* -mno-push-args */
  OPT_mno_red_zone = 1003,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1004,                       /* -mno-sse4 */
  OPT_mntapi = 1005,                         /* -mntapi */
  OPT_momit_leaf_frame_pointer = 1006,       /* -momit-leaf-frame-pointer */
  OPT_mout_implib = 1007,                    /* -mout-implib */
  OPT_moutput_def = 1008,                    /* -moutput-def */
  OPT_mpc = 1009,                            /* -mpc */
  OPT_mpclmul = 1010,                        /* -mpclmul */
  OPT_mpopcnt = 1011,                        /* -mpopcnt */
  OPT_mposix = 1012,                         /* -mposix */
  ...
  OPT_mtty_console = 1040,                   /* -mtty-console */
  OPT_mtune_ = 1041,                         /* -mtune= */
  OPT_mveclibabi_ = 1042,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1043,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1044,                    /* -mvzeroupper */
  OPT_mxop = 1045,                           /* -mxop */
  OPT_n = 1046,                              /* -n */
  ...
  OPT_std_c1x = 1095,                        /* -std=c1x */
  /* OPT_std_c89 = 1096, */                  /* -std=c89 */
  OPT_std_c90 = 1097,                        /* -std=c90 */
  OPT_std_c99 = 1098,                        /* -std=c99 */
  /* OPT_std_c9x = 1099, */                  /* -std=c9x */
  OPT_std_f2003 = 1100,                      /* -std=f2003 */
  OPT_std_f2008 = 1101,                      /* -std=f2008 */
